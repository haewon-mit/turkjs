...
<!-- 
<script src={{ "/assets/js/jsCookie-1.4.min.js" | prepend: site.baseurl | prepend: site.url }}></script>
<script src={{ "/assets/js/test.js" | prepend: site.baseurl | prepend: site.url }}></script>
...
Nick DePalma (Ph.D. candidate) <BR />
617 452 5603 <BR />
MIT Media Lab <BR />
E15-485 <BR />
Cambridge, MA 02139 <BR />
ndepalma@media.mit.edu <BR />

Associate Professor, Cynthia Breazeal <BR />
617 452 5601 <BR />
MIT Media Lab <BR />
E15-468 <BR />
Cambridge, MA 02139 <BR />
cynthiab@media.mit.edu <BR />
...
| [Agree]({{site.baseurl}}{% post_url 2015-09-27-Pick-Rand %}){: #agreeBut} | [Leave Immediately](http://www.google.com){: #declineBut} |
